...
from .models import Course, Lesson, News
...
• Работа с отзывами и рейтингом""",
    ...
    news_items = [
        {
            "title": "Новые правила сертификации товаров из Китая с 2026 года",
            "content": "С 1 февраля 2026 года вступают в силу обновлённые требования ЕАЭС к декларированию товаров электроники. Импортёрам необходимо обновить документы соответствия и протоколы испытаний. Подробности — в нашем закрытом канале для учеников.",
            "category": "news",
            "image_url": "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800",
        },
        {
            "title": "Курс юаня: как фиксировать цены при колебаниях",
            "content": "Юань укрепляется к рублю четвёртый месяц подряд. Разбираем три рабочих способа зафиксировать закупочную цену с китайскими поставщиками — от форвардных контрактов до расчётов в третьих валютах.",
            "category": "news",
            "image_url": "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=800",
        },
        {
            "title": "Анонс: вебинар по работе с маркетплейсами 15 мая",
            "content": "Открытый вебинар: как импортёру выйти на Wildberries и Ozon без штрафов за маркировку. Разбираем кейсы, отвечаем на вопросы. Запись будет доступна только зарегистрированным.",
            "category": "announcement",
            "image_url": "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=800",
        },
        {
            "title": "Анонс нового курса: Логистика из Китая 2.0",
            "content": "Запускаем обновлённый курс по логистике с учётом новых маршрутов через Казахстан и Монголию. Старт 20 мая, для подписчиков — скидка 30%.",
            "category": "announcement",
            "image_url": "https://images.unsplash.com/photo-1494412651409-8963ce7935a7?w=800",
        },
        {
            "title": "ТН ВЭД 8517.13.000.0 — Смартфоны",
            "content": "Код для смартфонов с функцией передачи данных. Пошлина 0%, НДС 20%. Требуется декларация о соответствии ТР ТС 020/2011, нотификация ФСБ для криптографии.",
            "category": "hscode",
        },
        {
            "title": "ТН ВЭД 6109.10.000.0 — Футболки из хлопка",
            "content": "Хлопковые футболки трикотажные. Пошлина 10%, но не менее 1.88 евро/кг. НДС 20%. Обязательна маркировка Честный ЗНАК.",
            "category": "hscode",
        },
        {
            "title": "ТН ВЭД 9504.50.000.0 — Видеоигровые консоли",
            "content": "Игровые приставки и аксессуары. Пошлина 0%, НДС 20%. Декларация о соответствии ТР ТС 020/2011 (ЭМС) обязательна.",
            "category": "hscode",
        },
        {
            "title": "Льготы по пошлинам для электротранспорта продлены",
            "content": "Правительство РФ продлило нулевую пошлину на электромобили и компоненты до конца 2026 года. Это касается кодов ТН ВЭД 8703.80, 8507.60 и ряда сопутствующих позиций.",
            "category": "news",
